...
pressure_min = 0 #MPa minimum pressure to look at
pressure_max = 100 #MPa maximum pressure to look at
x_property = 'Pressure' # property wanted on the x-axis as listed in NIST
y_property = 'Volume' # property wanted on the y-axis as listed in NIST
###
...
try:
	...
	### Second Page
	driver.find_element_by_xpath('//*[@id="main"]/form/ol/li[1]/input').send_keys(temperature) # T input
	driver.find_element_by_xpath('//*[@id="main"]/form/ol/li[2]/table/tbody/tr[1]/td[1]/input').send_keys(pressure_min) # PLow input
	driver.find_element_by_xpath('//*[@id="main"]/form/ol/li[2]/table/tbody/tr[2]/td[1]/input').send_keys(pressure_max) # PHigh input
...
df.plot.scatter(x=headers[x_index],y=headers[y_index],title=compound + " at " + temperature + "K",s=50)
